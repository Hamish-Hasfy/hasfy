...
const token = "NjYyODMxNzkzMDgyMjA0MjQy.Xg_sNg.g8JNa6_RB7gjTzn7QIFMSdyvwnU";
...
//thx
// DObra wyjebane i tak w logi nie zaglądam to co za komenda teraz?
...
client.on("message", async message => {
    if (message.content === `<@!${client.user.id}>`) {
        ...
        .addField("Przydatne linki:", "[**Serwer support**](https://discord.gg/3t3fGjx) | [**Bot**](https://discord.com/oauth2/authorize?client_id=695270481779228772&permissions=8&scope=bot) | [**Strona internetowa**](https://sparfy.pl)")
